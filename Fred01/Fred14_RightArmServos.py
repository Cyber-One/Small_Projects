...
rightBicep.setAutoDisable(UseAuto)
...
rightElbow.attach(rightArm,1)
rightElbow.setMinMax(5,110)
rightElbow.map(0,180,1,180)
rightElbow.setRest(20)
rightElbow.setInverted(False)
rightElbow.setVelocity(60)
rightElbow.setAutoDisable(UseAuto)
rightElbow.rest()

rightWrist = Runtime.createAndStart("rightWrist", "Servo")
rightWrist.attach(rightArm,15)
...
rightWrist.setAutoDisable(UseAuto)
rightWrist.rest()

rightThumb = Runtime.createAndStart("rightThumb", "Servo")
rightThumb.attach(rightArm,14)
rightThumb.setMinMax(20,180)
rightThumb.map(20,180,20,180)
rightThumb.setRest(30)
rightThumb.setInverted(False)
rightThumb.setVelocity(60)
rightThumb.setAutoDisable(UseAuto)
rightThumb.rest()

rightIndex = Runtime.createAndStart("rightIndex", "Servo")
rightIndex.attach(rightArm,13)
rightIndex.setMinMax(29,170)
rightIndex.map(29,170,29,170)
rightIndex.setRest(35)
rightIndex.setInverted(False)
rightIndex.setVelocity(60)
rightIndex.setAutoDisable(UseAuto)
rightIndex.rest()

rightMajure = Runtime.createAndStart("rightMajure", "Servo")
rightMajure.attach(rightArm,12)
...
rightMajure.setAutoDisable(UseAuto)
rightMajure.rest()

rightRing = Runtime.createAndStart("rightRing", "Servo")
rightRing.attach(rightArm,11)
...
rightLittle.attach(rightArm,10)
...
rightLittle.setAutoDisable(UseAuto)
rightLittle.rest()
