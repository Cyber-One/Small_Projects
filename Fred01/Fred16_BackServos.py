...
headRoll.setAutoDisable(UseAuto)
headRoll.rest()
...
backTopStomach.setAutoDisable(UseAuto)
backTopStomach.rest()
...
backMidStomach.setAutoDisable(UseAuto)
backMidStomach.rest()
...
backRightOmo.setAutoDisable(UseAuto)
backRightOmo.rest()
...
backRightShoulder.setAutoDisable(UseAuto)
...
backLeftOmo.setAutoDisable(UseAuto)
backLeftOmo.rest()
...
backLeftShoulder.setAutoDisable(UseAuto)
